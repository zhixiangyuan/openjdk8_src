...
public final class Matcher implements MatchResult {
    ...
    /**
     * Attempts to match the entire region against the pattern. 用一个给定的模式去匹配一个完整的字符串
     *
     ...
     * the pattern. 在一个字符串里寻找一个给定模式的匹配
     *
     ...
     * region, against the pattern. 用一个给定的模式去尝试匹配一个字符串的开头
     *
